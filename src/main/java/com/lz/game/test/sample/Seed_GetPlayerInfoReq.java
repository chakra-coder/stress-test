 ...
 * Date: 13-5-28
 */
public class Seed_GetPlayerInfoReq extends AbstractSample
{
    @Override
    ...
    {
        CommProto.RpcResponse resp = client.sendWaitBack(getRpcRequestBuilder(ServiceNameProto.ServiceName.PLAYER_VALUE, PlayerProto.MethodNameForPlayer.GET_PLAYER_INFO_VALUE, realReq));
        PlayerProto.GetPlayerInfoResp ret = PlayerProto.GetPlayerInfoResp.parseFrom(resp.getProtoParam());
        return ret;
    }
}
