 ...
 * Date: 13-5-28
 */
public class Seed_GetYouyuanBagInfoReq extends AbstractSample
{
    @Override
    ...
    {
        BagProto.GetYouyuanBagInfoReq.Builder req = BagProto.GetYouyuanBagInfoReq.newBuilder();
    ...
    {
        CommProto.RpcResponse resp = client.sendWaitBack(getRpcRequestBuilder(ServiceNameProto.ServiceName.BAG_VALUE, BagProto.MethodNameForBag.GET_YOUYUAN_BAG_INFO_VALUE, realReq));
        BagProto.GetYouyuanBagInfoResp ret = BagProto.GetYouyuanBagInfoResp.parseFrom(resp.getProtoParam());
        return ret;
    }
}
